...
final class Allegato implements DataObject
{
    ...
    public function toArray(): array
    {
        return [
            ...
            "vistoPoteriFirmaFatturaInfo" => $this->vistoPoteriFirmaFatturaInfo ?? [
                "importoFattura" => null,
            ],
            "vistoPoteriFirmaInfo" =>
    ...
    public static function fromArray(array $data): DataObject
    {
        return new self(
            ...
            vistoPoteriFirmaDichImpresa: $data["vistoPoteriFirmaDichImpresa"] ??
                0,
            vistoPoteriFirmaFattura: $data["vistoPoteriFirmaFattura"] ?? 0,
            vistoPoteriFirmaInfo: $data["vistoPoteriFirmaInfo"] ?? [],
            vistoPoteriFirmaFatturaInfo: $data["vistoPoteriFatturaInfo"] ?? [],
        );
    }
}
